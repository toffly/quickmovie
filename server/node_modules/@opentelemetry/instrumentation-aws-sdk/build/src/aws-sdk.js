...
class AwsInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    init() {
        ...
        const v3SmithyCoreClientFile = new instrumentation_1.InstrumentationNodeModuleFile('@smithy/core/dist-cjs/submodules/client/index.js', ['>=3.24.0'], this.patchV3SmithyClient.bind(this), this.unpatchV3SmithyClient.bind(this));
        const v3SmithyCore = new instrumentation_1.InstrumentationNodeModuleDefinition('@smithy/core', ['>=3.24.0'], undefined, undefined, [v3SmithyCoreClientFile]);
    ...
    patchV3SmithyClient(moduleExports, moduleVersion) {
    ...
    _getV3SmithyClientSendPatch(moduleVersion, original) {
        const self = this;
    ...
    patchV3MiddlewareStack(moduleVersion, middlewareStackToPatch) {
        ...
        if (!(0, instrumentation_1.isWrapped)(middlewareStackToPatch.clone)) {
            this._wrap(middlewareStackToPatch, 'clone', this._getV3MiddlewareStackClonePatch.bind(this, moduleVersion));
        }
        if (!(0, instrumentation_1.isWrapped)(middlewareStackToPatch.concat)) {
