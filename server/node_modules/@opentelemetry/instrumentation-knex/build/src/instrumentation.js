    ...
    createQueryWrapper(moduleVersion) {
        ...
        return function wrapQuery(original) {
            return function wrapped_logging_method(query) {
                ...
                const name = connectionSettings?.filename ||
                ...
                Object.assign(attributes, {
                    ...
                    [semantic_conventions_1.ATTR_SERVER_ADDRESS]: connectionSettings?.host ??
                        utils.extractHostFromConnectionString(connectionString),
                    [semantic_conventions_1.ATTR_SERVER_PORT]: connectionSettings?.port ??
