...
export declare function getSemanticAttributesFromConnection(params: PgParsedConnectionParams): Attributes;
export declare function getSemanticAttributesFromPoolConnection(params: PgPoolOptionsParams): Attributes;
