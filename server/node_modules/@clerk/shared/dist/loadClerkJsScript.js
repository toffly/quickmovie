...
const require_loadScript = require('./loadScript.js');
const require_proxy = require('./proxy.js');
const require_url = require('./url.js');
const require_versionSelector = require('./versionSelector.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.30.2");
