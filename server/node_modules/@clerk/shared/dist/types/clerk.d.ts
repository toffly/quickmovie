...
import { BillingCheckoutResource, BillingNamespace, BillingPlanResource, BillingSubscriptionPlanPeriod, CheckoutFlowResource, ForPayerType } from "./billing.js";
import { OAuthProvider, OAuthScope } from "./oauth.js";
import { Web3Strategy } from "./strategies.js";
import { ProtectAssertion } from "./protectConfig.js";
import { AfterMultiSessionSingleSignOutUrl, AfterSignOutUrl, NewSubscriptionRedirectUrl, RedirectOptions, RedirectUrlProp, SignInFallbackRedirectUrl, SignInForceRedirectUrl, SignUpFallbackRedirectUrl, SignUpForceRedirectUrl } from "./redirects.js";
import { ClerkAPIResponseError } from "./errors.js";
import { SignInResource } from "./signIn.js";
import { ClientJSONSnapshot, EnvironmentJSONSnapshot } from "./snapshots.js";
import { SessionVerificationLevel } from "./sessionVerification.js";
import { UserResource } from "./user.js";
import { SessionResource, SessionTask, SignedInSessionResource } from "./session.js";
import { OrganizationResource } from "./organization.js";
import { OrganizationCustomRoleKey } from "./organizationMembership.js";
import { DisplayThemeJSON } from "./json.js";
...
import { LocalizationResource } from "./localization.js";
import { DomainOrProxyUrl, MultiDomainAndOrProxy } from "./multiDomain.js";
import { OAuthApplicationNamespace } from "./oauthApplication.js";
import { OAuthTransport } from "./oauthTransport.js";
import { JoinWaitlistParams, WaitlistResource } from "./waitlist.js";
import { State } from "./state.js";
import { TelemetryCollector } from "./telemetry.js";
import { APIKeysNamespace } from "./apiKeys.js";
...
type ClerkOptions = ClerkOptionsNavigation & SignInForceRedirectUrl & SignInFallbackRedirectUrl & SignUpForceRedirectUrl & SignUpFallbackRedirectUrl & NewSubscriptionRedirectUrl & AfterSignOutUrl & AfterMultiSessionSingleSignOutUrl & ClerkUnsafeOptions & {
   ...
   */
  telemetry?: false | {
    /** Whether telemetry will be collected. */disabled?: boolean; /** Whether telemetry events are only logged to the console and not sent to Clerk. */
...
type PrimitiveKeys<T> = { [K in keyof T]: T[K] extends string | boolean | number | null ? K : never }[keyof T];
