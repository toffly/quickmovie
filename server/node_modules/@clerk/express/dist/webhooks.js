...
async function verifyWebhook(req, options) {
	const webRequest = require_utils.incomingMessageToRequest(req);
	let serializedBody;
	...
	return (0, _clerk_backend_webhooks.verifyWebhook)(new Request(webRequest, { body: serializedBody }), options);
}

//#endregion
exports.verifyWebhook = verifyWebhook;
Object.keys(_clerk_backend_webhooks).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return _clerk_backend_webhooks[k]; }
  });
});
