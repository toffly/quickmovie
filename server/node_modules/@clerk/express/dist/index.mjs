import { a as requestHasAuthObject, i as loadClientEnv, n as incomingMessageToRequest, o as requestToProxyRequest, r as loadApiEnv, t as brandRequestAuth } from "./utils-Tk_mhMlq.mjs";
import { createClerkClient } from "@clerk/backend";
import { Readable } from "stream";
import { AuthStatus, createClerkRequest, getAuthObjectForAcceptedToken } from "@clerk/backend/internal";
import { DEFAULT_PROXY_PATH, clerkFrontendApiProxy, stripTrailingSlashes } from "@clerk/backend/proxy";
...
const requireAuth = (options = {}) => {
	...
	return (request, response, next) => {
		deprecated("requireAuth", "Use `clerkMiddleware()` with `getAuth()` instead. `requireAuth` will be removed in the next major version.");
