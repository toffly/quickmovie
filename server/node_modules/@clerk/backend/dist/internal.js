...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"3.16.5"}`;
...
var AuthenticateContext = class {
  ...
  isKnownClerkReferrer() {
    ...
    try {
      ...
      if (this.instanceType !== "production" && ((0, import_url2.isLegacyDevAccountPortalOrigin)(referrerHost) || (0, import_url2.isCurrentDevAccountPortalOrigin)(referrerHost))) {
        return true;
      }
