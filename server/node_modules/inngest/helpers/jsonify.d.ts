import { IsAny, IsLiteral, IsNever, IsUnknown, KnownKeys, Simplify } from "./types.js";
...
own output.
*/
type FilterJsonableKeys<T extends object> = Exclude<{ [Key in keyof T]: T[Key] extends NotJsonable ? never : Key }[keyof T], undefined>;
/**
