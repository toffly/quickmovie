...
declare namespace errors_d_exports {
  export { ErrCode, OutgoingResultError, SerializedError, UnreachableError, deserializeError, fixEventKeyMissingSteps, getErrorMessage, isSerializedError, rethrowError, serializeError };
}
 ...
 */
declare const serializeError: <TAllowUnknown extends boolean = false, TOutput extends (TAllowUnknown extends true ? unknown : SerializedError) = (TAllowUnknown extends true ? unknown : SerializedError)>(
/**
 ...
 * {@link serializeError}.
 */
declare const isSerializedError: (value: unknown) => SerializedError | undefined;
/**
 ...
 */
declare const deserializeError: <TAllowUnknown extends boolean = false, TOutput extends (TAllowUnknown extends true ? unknown : Error) = (TAllowUnknown extends true ? unknown : Error)>(subject: Partial<SerializedError>, allowUnknown?: TAllowUnknown) => TOutput;
