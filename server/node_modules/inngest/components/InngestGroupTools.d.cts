import { IsNever } from "../helpers/types.cjs";
import { ExperimentRef, StepOptionsOrId } from "../types.cjs";
...
interface GroupExperiment {
  <TVariants extends Record<string, () => unknown>>(idOrOptions: StepOptionsOrId, options: ExperimentOptions<TVariants>): Promise<{
...
//#endregion
export { ExperimentSelectFn, GroupExperiment, GroupTools, GroupToolsDeps, ParallelOptions, createGroupTools };
//# sourceMappingURL=InngestGroupTools.d.cts.map