...
import { ClientScore } from "./InngestScore.cjs";
...
import { ApplyAllMiddlewareCtxExtensions, ApplyAllMiddlewareStepExtensions, ApplyAllMiddlewareTransforms, BaseContext, ClientOptions, EventMeta, EventPayload, FailureEventArgs, Handler, InvokeTargetFunctionDefinition, JsonError, SendEventBaseOutput, SendEventOutput, SendSignalResponse, TimeStr, TimeStrBatch } from "../types.cjs";
import { FeatureObservations } from "../proto/src/components/sdkFeatureObservations/protobuf/feature_observations.cjs";
import { SandboxClient } from "./sandbox/types.cjs";
import { FeatureObservationState, featureObservationStateSymbol, featureObservationsSymbol } from "./sdkFeatureObservations.cjs";
 ...
 * @internal
 */
declare const sessionPropagationSymbol: unique symbol;
declare class Inngest<const TClientOpts extends ClientOptions = ClientOptions> implements Inngest.Like {
   ...
   */
  protected experimentalScoreEnabled: boolean;
  /**
  ...
  private hasEventApiOriginOverride;
...
//#endregion
export { ClientOptionsFromInngest, GetFunctionInput, GetFunctionOutput, GetFunctionOutputRaw, GetStepTools, Inngest, builtInMiddleware };
