...
import { ScoreStepTool, scoreSymbol } from "./InngestScore.cjs";
import { Middleware } from "./middleware/middleware.cjs";
import { InngestExecution } from "./execution/InngestExecution.cjs";
import { ApplyAllMiddlewareTransforms, Context, EventMeta, EventPayload, HashedOp, InvocationResult, InvokeTargetFunctionDefinition, OutgoingOp, ReceivedEventMeta, SendEventOutput, SendSignalResponse, StepOptions, StepOptionsOrId, TriggerEventFromFunction } from "../types.cjs";
...
declare const createStepTools: <TClient extends Inngest.Any, TFnMiddleware extends Middleware.Class[] | undefined = undefined>(client: TClient, execution: InngestExecution, stepHandler: StepHandler) => {
   ...
   */
  sendSignal: (idOrOptions: StepOptionsOrId, opts: SendSignalOpts) => Promise<SendSignalResponse>;
  /**
