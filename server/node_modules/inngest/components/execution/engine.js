...
import { normalizeEventMeta, reduceEventsToPropagatedSessions, stampPropagatedSessionsOnEvent } from "../../helpers/sessions.js";
		...
		return (idOrOptions, { function: deferFn, data, experiment, meta }) => {
			...
			try {
				...
				if (this.options.client[sessionPropagationSymbol]) {
					...
					if (propagated && Object.keys(propagated).length > 0) deferMeta = {
						...deferMeta,
