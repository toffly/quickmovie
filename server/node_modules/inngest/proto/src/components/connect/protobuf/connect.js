import { FeatureObservations } from "../../sdkFeatureObservations/protobuf/feature_observations.js";
...
const AppConfiguration = {
	encode(message, writer = new BinaryWriter()) {
		...
		if (message.featureObservations !== void 0) FeatureObservations.encode(message.featureObservations, writer.uint32(42).fork()).join();
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
	...
	fromJSON(object) {
		return {
			...
			featureObservations: isSet(object.featureObservations) ? FeatureObservations.fromJSON(object.featureObservations) : void 0
		};
	},
	toJSON(message) {
		const obj = {};
		...
		if (message.featureObservations !== void 0) obj.featureObservations = FeatureObservations.toJSON(message.featureObservations);
		return obj;
	},
	create(base) {
	...
	fromPartial(object) {
		...
		message.featureObservations = object.featureObservations !== void 0 && object.featureObservations !== null ? FeatureObservations.fromPartial(object.featureObservations) : void 0;
		return message;
	}
};
