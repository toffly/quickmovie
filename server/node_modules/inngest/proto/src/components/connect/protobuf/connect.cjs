...
const require_feature_observations = require('../../sdkFeatureObservations/protobuf/feature_observations.cjs');
...
const AppConfiguration = {
	encode(message, writer = new __bufbuild_protobuf_wire.BinaryWriter()) {
		...
		if (message.featureObservations !== void 0) require_feature_observations.FeatureObservations.encode(message.featureObservations, writer.uint32(42).fork()).join();
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof __bufbuild_protobuf_wire.BinaryReader ? input : new __bufbuild_protobuf_wire.BinaryReader(input);
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 5:
					if (tag !== 42) break;
					message.featureObservations = require_feature_observations.FeatureObservations.decode(reader, reader.uint32());
					continue;
			}
			if ((tag & 7) === 4 || tag === 0) break;
			reader.skip(tag & 7);
	...
	fromJSON(object) {
		return {
			...
			featureObservations: isSet(object.featureObservations) ? require_feature_observations.FeatureObservations.fromJSON(object.featureObservations) : void 0
		};
	},
	toJSON(message) {
		const obj = {};
		...
		if (message.featureObservations !== void 0) obj.featureObservations = require_feature_observations.FeatureObservations.toJSON(message.featureObservations);
		return obj;
	},
	create(base) {
	...
	fromPartial(object) {
		...
		message.featureObservations = object.featureObservations !== void 0 && object.featureObservations !== null ? require_feature_observations.FeatureObservations.fromPartial(object.featureObservations) : void 0;
		return message;
	}
};
